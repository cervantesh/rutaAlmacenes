 ...
 * @author Seelee
 */
public class FormModificarAlmacen extends javax.swing.JFrame {

    /**
     * Creates new form FormManipulacionAlmacen
     */
    public FormModificarAlmacen() {
        initComponents();
        aplicarFormatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormModificarAlmacen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
